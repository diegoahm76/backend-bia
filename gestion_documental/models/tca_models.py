...
class PermisosGD(models.Model):
    ...
    tipo_permiso=models.CharField(max_length=20, unique=True, db_column='T213nombre')
...
class PermisosCatSeriesUnidadOrgTCA(models.Model):
    ...
    id_unidad_org_cargo=models.ForeignKey(UnidadesOrganizacionales, on_delete=models.CASCADE, db_column='T221Id_UnidadOrgPersona')
    ...
    ruta_archivo_cambio=models.FileField(max_length=255, upload_to='gestion_documental/permisos_tca/', blank=True, null=True, db_column='T221rutaArchivoCambio')
...
class HistoricoPermisosCatSeriesUndOrgTCA(models.Model):
    ...
    justificacion = models.CharField(max_length=255, blank=True, null=True, db_column='T223justificacionDelCambio')
    ruta_archivo = models.FileField(max_length=255, upload_to='gestion_documental/historico_permisos_tca/', blank=True, null=True, db_column='T223rutaArchivoCambio')
