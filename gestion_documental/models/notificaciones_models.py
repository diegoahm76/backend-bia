...
class Registros_NotificacionesCorrespondecia(models.Model):
    ...
    fecha_asignacion = models.DateTimeField(db_column='T352fechaAsignacion')
    id_persona_asigna = models.ForeignKey('transversal.Personas', on_delete=models.CASCADE, db_column='T352Id_PersonaAsigna',related_name='T352IdPersonaAsigna')
    id_persona_asignada = models.ForeignKey('transversal.Personas', on_delete=models.CASCADE, db_column='T352Id_PersonaAsignada',related_name='T352IdPersonaAsignada')
    cod_estado_asignacion = models.CharField(choices=ESTADO_ASIGNACION_CHOICES, max_length=2, db_column='T352codEstadoAsignacion')
    fecha_eleccion_estado = models.DateTimeField(db_column='T352fechaEleccionEstado')
    ...
    fecha_final_registro = models.DateTimeField(db_column='T352fechaFinalRegistro')
...
class AsignacionNotificacionCorrespondencia(models.Model):
    ...
    cod_estado_asignacion = models.CharField(choices=ESTADO_ASIGNACION_CHOICES, max_length=2, db_column='T351codEstadoAsignacion')
    fecha_eleccion_estado = models.DateTimeField(db_column='T351fechaEleccionEstado')
