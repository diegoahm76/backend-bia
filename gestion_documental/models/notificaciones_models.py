...
class NotificacionesCorrespondencia(models.Model):
    ...
    id_PQRSDF = models.ForeignKey('gestion_documental.PQRSDF', on_delete=models.SET_NULL, null=True, blank=True, db_column='T350Id_PQRSDF',related_name='T350IdPQRSDF')
...
class TiposNotificacionesCorrespondencia(models.Model):
    ...
    publicar_pagina_gaceta = models.BooleanField(db_column='T354publicarPaginaGaceta')
    publicar_pagina_edictos = models.BooleanField(db_column='T354publicarPaginaEdictos')
...
class TiposDocumentos(models.Model):
    ...
    aplica_para_publicaciones = models.BooleanField(db_column='T359aplicaParaPublicaciones')
    aplica_para_comunicaciones = models.BooleanField(db_column='T359aplicaParaComunicaciones')
    aplica_para_notificaciones_publicaciones = models.BooleanField(db_column='T359aplicaParaNotificacionesPublicaciones')
