...
class TransferenciasDocumentales(models.Model):
    ...
    fecha_transferenciaExp = models.DateTimeField(db_column='T302fechaTransferencia')
    nro_expedientes_transferidos = models.SmallIntegerField(db_column='T302nroExpedientesTransferidos')
