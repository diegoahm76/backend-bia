    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_clas_expediente', models.CharField(choices=[('P', 'Público'), ('C', 'Controlado'), ('R', 'Rerservado')], db_column='T215Cod_ClasificacionExp', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_clas_expediente', models.CharField(db_column='T214CodClasificacionExp', max_length=1)),
