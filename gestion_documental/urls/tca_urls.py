...
urlpatterns = [
    ...
    path('cargo-serie-subserie-unidad-tca/delete/<str:id_trd>/',views.EliminarRelaciones.as_view(),name='cargo-serie-subserie-unidad-tca-delete'),
    ...
    path('get-series-subs-unidadorg-tca/<str:id_tca>/',views.GetSeriesSubSUnidadOrgTCA.as_view(),name='get-series-sub-unidad-tca'),
]