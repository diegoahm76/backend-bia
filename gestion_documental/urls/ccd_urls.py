...
urlpatterns = [
    ...
    path('get-oficinas-unidad-nueva/get/<str:id_unidad_org_actual>/', views.OficinasUnidadOrganizacionalNuevaGetView.as_view(),name='obtener-oficinas-unidad-actual'),
