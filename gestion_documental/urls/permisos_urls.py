...
urlpatterns = [
    ...
    path('unidades-externas-permisos/get/<str:id_cat_serie_und>/', views.UnidadesExternasPermisosGetView.as_view(),name='unidades-externas-permisos-get'),
    path('restricciones-permisos/get/<str:id_cat_serie_und>/', views.DenegacionPermisosGetView.as_view(),name='unidades-permisos-get'),
