...
from gestion_documental.serializers.complementos_opa_serializers import Anexos_RequerimientoCreateSerializer
from gestion_documental.serializers.complementos_pqr_serializers import ComplementoPQRSDFPostSerializer, ComplementoPQRSDFPutSerializer, ComplementosSerializer, ComplementosUsu_PQRPostSerializer, PQRSDFSerializer, PersonaSerializer, SolicitudPQRSerializer
...
class RespuestaRequerimientoSobrePQRSDFCreate(generics.CreateAPIView):
    serializer_class = ComplementosUsu_PQRPostSerializer
    ...
    def post(self, request):
        fecha_actual =datetime.now()
        solicitud_usu_PQRSDF = request.data.get('ComplementosUsu_PQR')
