...
from seguridad.models import Modulos
...
class Notificacion(models.Model):
    ...
    id_destinatario = models.ForeignKey(Personas, on_delete=models.CASCADE, related_name='persona_destinatario', db_column='T031Id_Destinatario')
    id_funcionario = models.ForeignKey(Personas, on_delete=models.CASCADE, related_name='persona_funcionario', db_column='T031Id_Funcionario')
    ...
    id_modulo_generador = models.ForeignKey(Modulos, on_delete=models.CASCADE, db_column='T031Id_moduloGenerador')
...
class DespachoNotificacion(models.Model):
    ...
    id_funcionario = models.ForeignKey(Personas, on_delete=models.CASCADE, db_column='T032Id_Funcionario')
