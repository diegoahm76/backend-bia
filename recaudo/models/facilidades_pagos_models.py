...
class FacilidadesPago(models.Model):
    ...
    id_deudor = models.ForeignKey('transversal.Personas', on_delete=models.CASCADE, related_name='facilidad_persona_deudor', db_column='T426Id_Deudor')
    ...
    id_funcionario = models.ForeignKey('transversal.Personas', on_delete=models.CASCADE, related_name='facilidad_persona_funcionario', db_column='T426Id_Funcionario')
