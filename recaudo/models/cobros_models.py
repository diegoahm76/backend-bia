...
class DocumentosCobro(models.Model):
    ...
    fecha_cobro = models.DateField(db_column='T405fecha_cobro')
    vencimiento = models.DateField(db_column='T405vencimiento')
    valor_deuda = models.FloatField(default=0, db_column='T405valor_deuda')
    tasa_interes = models.ForeignKey(TasasInteres, on_delete=models.CASCADE, default=0, db_column='T405tasa_interes')
    valor_mora = models.FloatField(default=0, db_column='T405valor_mora')
    porcentaje_descuento = models.FloatField(default=0, db_column='T405porcentaje_descuento')
    valor_descuento = models.FloatField(default=0, db_column='T405valor_descuento')
    valor_total = models.FloatField(default=0, db_column='T405valor_total')
...
class Cartera(models.Model):
    ...
    fecha_facturacion = models.DateField(null=True, blank=True, db_column='T417fecha_facturacion')
    fecha_notificacion = models.DateField(null=True, blank=True, db_column='T417fecha_notificacion')
    fecha_ejecutoriado = models.DateField(null=True, blank=True, db_column='T417fecha_ejecutoriado')
    ...
    tipo_cobro = models.CharField(max_length=255, db_column='T417tipo_cobro')
