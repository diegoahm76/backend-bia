...
urlpatterns = [
    ...
    path('plan-obligaciones-facilidad/<int:id_facilidad_pago>/', views.PlanPagosAmortizacionDatosView.as_view(),name='plan-obligaciones-facilidad'),
    path('amortizacion/<int:id_facilidad_pago>/', views.PlanPagosAmortizacionListaViews.as_view(),name='plan-obligaciones-facilidad'),
