...
# class Creardocumento_formulario_recuado(generics.CreateAPIView):
#     queryset = documento_formulario_recuado.objects.all()
#     serializer_class = documento_formulario_recuados_serializer

#     def create(self, request, *args, **kwargs):
#         try:
#             archivo = request.FILES.get('ruta_archivo_info_tecnico')
#             archivo_digital_id = self.crear_archivo_digital(archivo)

#             request.data['id_archivo_sistema'] = archivo_digital_id
...
#     def crear_archivo_digital(self, archivo):
#         try:
#             # Utiliza la clase HttpRequest de Django
#             request_django = HttpRequest()

#             # Asegúrate de pasar la instancia correcta al método as_view()
#             respuesta_archivo = ArchivosDgitalesCreate.as_view()(request_django)
#             archivo_digital_id = respuesta_archivo.data['data']['id_archivo_digital']
            
#             return archivo_digital_id

#         except Exception as e:
#             print(f"No se pudo crear el archivo digital: {str(e)}")
#             return None
...
#             if archivo:
#                 # Procesar el archivo y obtener el ID del archivo digital
#                 archivo_digital_id = self.archivos_dgitales_create.crear_archivo({}, archivo).data['data']['id_archivo_digital']

#                 # Agregar el ID del archivo digital a los datos del documento
#                 request.data['id_archivo_sistema'] = archivo_digital_id
