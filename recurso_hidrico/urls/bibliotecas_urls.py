...
urlpatterns = [
    ...
    path('dato_registro_laboratorio/get-by-resultado/<str:lab>/<str:par>/',views.DatosRegistroLaboratorioByResultadosLaboratorioGet.as_view(),name='get-dato_registro_laboratorio-by-resultado'),
