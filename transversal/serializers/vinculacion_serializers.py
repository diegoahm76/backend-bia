...
class ConsultaVinculacionColaboradorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Personas
        fields = ("id_unidad_organizacional_actual","id_cargo",'cargo_actual','unidad_organizacional_actual',"es_unidad_organizacional_actual",'fecha_inicio_cargo_actual', 'fecha_asignacion_unidad', 'fecha_a_finalizar_cargo_actual', 'observaciones_vinculacion_cargo_actual','fecha_vencida')
