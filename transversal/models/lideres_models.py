...
class LideresUnidadesOrg(models.Model):
    ...
    id_persona = models.ForeignKey('transversal.Personas', on_delete=models.SET_NULL, blank=True, null=True, related_name='id_persona_lider', db_column='T029Id_Persona')
    fecha_asignacion = models.DateTimeField(auto_now_add=True, db_column='T029fechaAsignacion')
    id_persona_asigna = models.ForeignKey('transversal.Personas', on_delete=models.CASCADE, related_name='id_persona_asigna_lider', db_column='T029Id_PersonaAsigna')
