...
def generar_alerta_segundo_plano():
    ...
    for programada in alertas_generadas:
            ...
            if  programada.activa :
                ...
                dias_post=programada.ctdad_repeticiones_post
                print(dias_pre)
                print(dias_post)
                
                fecha_lim_inferior=fecha_actual - timedelta(days=programada.ctdad_dias_alertas_previas)
                fecha_lim_superior= fecha_actual + timedelta(days=programada.ctdad_repeticiones_post)
                print(fecha_lim_inferior)
                print(fecha_actual)
                print(fecha_lim_superior)
