...
class AnexosTramite(models.Model):
    ...
    id_documento_lista_chequeo = models.ForeignKey('DocumentosListasChequeo', on_delete=models.CASCADE, null=True, blank=True, db_column='T287Id_DocumentoListaChequeo')
