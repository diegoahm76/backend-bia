...
class SeguimientoPOAI(models.Model):
    ...
    valor_fte1 = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537valorFte1')
    ...
    valor_fte2 = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537valorFte2')
    ...
    valor_fte3 = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537valorFte3')
    ...
    valor_fte4 = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537valorFte4')
    adicion4 = models.BooleanField(null=True, blank=True, db_column='T537adicion4')
    valor_banco = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537valorBanco')
    valor_cdp = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537valorCDP')
    valor_rp = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537valorRP')
    valor_obligado = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537valorObligado')
    ...
    valor_mensual = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537valorMensual')
    ...
    id_codigo_unsp = models.ForeignKey(CodigosUNSP, on_delete=models.CASCADE, db_column='T537codigoUNSP')
    ...
    fecha_registro = models.DateField(db_column='T537fechaRegistro')
    valor_pagado = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537valorPagado')
    vseguimiento_paabanco = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537vseguimientoPAABanco')
    vseguimiento_paacdp = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537vseguimientoPAACDP')
    vseguimiento_paarp = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537vseguimientoPAARP')
    svseguimiento_paaobligado = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537svseguimientoPAAObligado')
    vseguimiento_paapagado = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, db_column='T537vseguimientoPAAPagado')
