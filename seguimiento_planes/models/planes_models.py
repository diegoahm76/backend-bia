...
class ArmonizarPAIPGAR(models.Model):
    ...
    id_planPGAR = models.ForeignKey(Planes, on_delete=models.CASCADE, db_column='T535IdPlanPGAR')
    id_planPAI = models.ForeignKey(Planes, on_delete=models.CASCADE, db_column='T535IdPlanPAI')
...
class SeguimientoPGAR(models.Model):
    ...
    id_indicador = models.ForeignKey(Indicador, on_delete=models.CASCADE, db_column='T536IdIndicador')
    ...
    id_indicador_seg = models.ForeignKey(Indicador, on_delete=models.CASCADE, db_column='T536IdIndicadorSeg')
