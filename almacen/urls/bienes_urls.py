...
urlpatterns = [
    ...
    #Catalogo Bienes Y
    path('catalogo-bienes-generador-codigo/<str:nivel_jerarquico>/<str:id_bien_padre>/', views.GeneradorCodigoCatalogo.as_view(), name='catalogo-bienes-generador-codigo'),
