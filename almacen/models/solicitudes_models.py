...
class SolicitudesConsumibles(models.Model):
    ...
    id_unidad_para_la_que_solicita = models.ForeignKey(UnidadesOrganizacionales, on_delete=models.CASCADE, db_column='T081Id_FuncionarioResponsableUnidad', related_name='funcionario_responsable_unidad')
    ...
    id_unidad_org_del_responsable = models.ForeignKey(UnidadesOrganizacionales, on_delete=models.CASCADE, db_column='T081Id_UnidadOrgDelSolicitante', related_name='unidad_org_del_responsable')
    ...
    rechazada_almacen = models.BooleanField(db_column='T081revisadaResponsable', null=True, blank=True)
...
class ItemsSolicitudConsumible(models.Model):
    ...
    id_solicitud_consumibles = models.ForeignKey(SolicitudesConsumibles, on_delete=models.CASCADE, db_column='T082Id_SolicitudesConsumibles')
    ...
    id_unidad_medid = models.ForeignKey(UnidadesMedida, on_delete=models.CASCADE, db_column='T082Id_UnidadMedida')
