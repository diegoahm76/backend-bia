...
class SolicitudesConsumibles(models.Model):
    ...
    fecha_aprobacion_responsable = models.DateField(db_column='T081fechaAprobacionResponsable', null=True, blank=True)
...
class DespachoConsumo(models.Model):
    ...
    numero_despacho_consumo = models.PositiveIntegerField(unique=True, db_column='T083nroDespachoConsumo')
    ...
    numero_solicitud_por_tipo = models.PositiveIntegerField(null=True, blank=True, db_column='T083nroSolicitudPorTipo')
    ...
    id_bodega_general = models.ForeignKey(Bodegas, on_delete=models.CASCADE, db_column='T083Id_BodegaGral')
...
class ItemDespachoConsumo(models.Model):
    ...
    cantidad_solicitada = models.PositiveIntegerField(null=True, blank=True, db_column='T084cantidadSolicitada')
    ...
    cantidad_despachada = models.PositiveIntegerField(db_column='T084cantidadDespachada')
    observacion = models.CharField(max_length=50, null=True, blank=True, db_column='T084observacion')
    numero_posicion_despacho = models.PositiveIntegerField(db_column='T084nroPosicionEnDespacho')
