...
class VehiculosAgendables_Conductor(models.Model):
    ...
    id_persona_conductor =  models.ForeignKey("seguridad.Personas",on_delete=models.CASCADE,db_column="T072Id_PersonaConductor", related_name='T072id_persona_conductor')
    ...
    id_persona_que_asigna = models.ForeignKey("seguridad.Personas",on_delete=models.CASCADE,db_column="T072Id_PersonaQueAsigna",related_name='T072id_persona_que_asigna')
    fecha_registro = models.DateTimeField(auto_now_add=True,db_column="T072fechaRegistro")
    id_persona_actualiza_dif_crea = models.ForeignKey("seguridad.Personas",on_delete=models.SET_NULL,null=True,blank=True,db_column="T072Id_PersonaUltActualizacionDifCrea")
    fecha_ultima_actualizacion_dif_crea = models.DateTimeField(null=True,blank=True,db_column="T072fechaUltimaActualizacionDifCrea")
...
class InspeccionesVehiculosDia(models.Model):
    ...
    id_persona_inspecciona = models.ForeignKey("seguridad.Personas",on_delete=models.CASCADE,db_column="T073Id_PersonaQueInspecciona",related_name="T073id_persona_inspecciona")
    ...
    id_persona_que_verifica = models.ForeignKey("seguridad.Personas",on_delete=models.SET_NULL,null=True,blank=True,db_column="T073Id_PersonaQueVerifica",related_name="T073id_persona_que_verifica")
...
class VehiculosAgendadosDiaDisponible(models.Model):
    ...
    id_persona_registra = models.ForeignKey("seguridad.Personas",on_delete=models.CASCADE,db_column="T074Id_PersonaQueRegistra")
...
class SolicitudesViajes(models.Model):
    ...
    id_persona_solicita = models.ForeignKey("seguridad.Personas",on_delete=models.CASCADE,db_column="T075Id_PersonaSolicita",related_name="T075id_persona_solicita")
    id_unidad_org_solicita = models.ForeignKey("transversal.Organigramas",on_delete=models.CASCADE,db_column="T075Id_UnidadOrgSolicitante",related_name="T075id_unidad_org_solicita")
    ...
    cod_municipio = models.ForeignKey("seguridad.Municipio",on_delete=models.CASCADE,db_column="T075Cod_MunicipioDestino")
    indicaciones_destino = models.CharField(max_length=255,db_column="T075indicacionesDestino")
    nro_pasajeros = models.PositiveSmallIntegerField(db_column="nroPasajeros")
    requiere_carga = models.BooleanField(default=True,db_column="T075requiereCarga")
    fecha_partida = models.DateField(db_column="T075fechaPartido")
    ...
    apoyo_fuerza_publica = models.BooleanField(null=True,blank=True,db_column="T075reqCompaniaMilitar")
    ...
    id_funcionario_responsable = models.ForeignKey("seguridad.Personas",on_delete=models.CASCADE,db_column="T075Id_FuncionarioResponsable",related_name="T075id_funcionario_responsable")
    id_unidad_org_responsable = models.ForeignKey("transversal.Organigramas",on_delete=models.CASCADE,db_column="T075Id_UnidadOrgResponsable",related_name="T075id_unidad_org_responsable")
    ...
    id_persona_rechaza_solicitud = models.ForeignKey("seguridad.Personas",on_delete=models.SET_NULL,null=True,blank=True,db_column="T075Id_PersonaRechazaSolicitud",related_name="T075id_persona_rechaza_solicitud")
    ...
    id_persona_cierra_viaje = models.ForeignKey("seguridad.Personas",on_delete=models.SET_NULL,null=True,blank=True,db_column="T075Id_PersonaCierraViaje",related_name="T075id_persona_cierra_viaje")
    ...
    fecha_cierre_viaje = models.DateTimeField(null=True,blank=True,db_column="fechaCierreViaje")
...
class AsignacionesViajeAgendado(models.Model):
    ...
    id_persona_asigna = models.ForeignKey("seguridad.Personas",on_delete=models.SET_NULL,null=True,blank=True,db_column="T076Id_PersonaAsigna",related_name="T076id_persona_asigna")
    ...
    id_persona_rechaza = models.ForeignKey("seguridad.Personas",on_delete=models.SET_NULL,null=True,blank=True,db_column="T076Id_PersonaRechaza",related_name="T076id_persona_rechaza")
    justificacion_rechazo = models.CharField(max_length=255,null=True,blank=True,db_column="T076justificacionRechazo")
    fecha_rechazo = models.DateTimeField(db_column="T076fechaRechazo")
    asignacion_anulada = models.BooleanField(null=True,blank=True,db_column="T076asignacionAnulada")
    id_persona_anula = models.ForeignKey("seguridad.Personas",on_delete=models.SET_NULL,null=True,blank=True,db_column="T076Id_PersonaAnula",related_name="T076id_persona_anula")
...
class ViajesAgendados(models.Model):
    ...
    municipio_destino = models.ForeignKey("seguridad.Municipio",on_delete=models.CASCADE,db_column="T077Cod_MunicipioDestino")
    indicaciones_destino = models.CharField(max_length=255,null=True,blank=True,db_column="T077indicacionesDestino")
    nro_pasajeros = models.PositiveSmallIntegerField(db_column="T077nroTotalPasajerosReq")
    ...
    id_persona_autoriza = models.ForeignKey("seguridad.Personas",on_delete=models.SET_NULL,null=True,blank=True,db_column="T077Id_PersonaAutoriza")
...
class BitacoraViaje(models.Model):
    ...
    id_conductor = models.ForeignKey("seguridad.Personas",on_delete=models.SET_NULL,null=True,blank=True,db_column="T079Id_ConductorQueParte")
