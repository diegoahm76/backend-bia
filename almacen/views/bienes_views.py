...
class BusquedaAvanzadaCatalogoBienesDespacho(generics.ListAPIView):
    serializer_class = CatalogoBienesSerializer

    def get_queryset(self):
        # Filtrar nodos de nivel 2-5 de activos según las condiciones especificadas
        queryset = CatalogoBienes.objects.filter(nivel_jerarquico=(5), visible_solicitudes=True, cod_tipo_bien='A')
        return queryset
