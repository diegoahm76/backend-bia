...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='T062Cod_EstadoDelActivo', null=True, on_delete=django.db.models.deletion.SET_NULL, to='almacen.estadosarticulo'),
        ),
        migrations.AddField(
            model_name='inventario',
