...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='T081Id_PersonaSolicita', on_delete=django.db.models.deletion.CASCADE, related_name='persona_solicita', to='seguridad.personas'),
        ),
        migrations.AddField(
            model_name='solicitudesconsumibles',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='T081Id_UnidadParaLaQueSolicita', on_delete=django.db.models.deletion.CASCADE, related_name='funcionario_responsable_unidad', to='almacen.unidadesorganizacionales'),
        ),
        migrations.AddField(
