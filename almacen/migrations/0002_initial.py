...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='solicitudesconsumibles',
            name='id_persona_almacen_rechaza',
            field=models.ForeignKey(blank=True, db_column='T081Id_PersonaAlmacenRechaza', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='persona_rechaza_almacen', to='seguridad.personas'),
        ),
        migrations.AddField(
            model_name='solicitudesconsumibles',
            name='id_persona_cierre_no_dispo_alm',
            field=models.ForeignKey(blank=True, db_column='T081Id_PersonaCierreNoDispoAlm', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='persona_cierre_no_disponible', to='seguridad.personas'),
        ),
        migrations.AddField(
            model_name='solicitudesconsumibles',
        ...
        migrations.AddField(
            model_name='itemdespachoconsumo',
            name='id_bien_despachado',
            field=models.ForeignKey(blank=True, db_column='T084Id_BienDespachado', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bien_despachado', to='almacen.catalogobienes'),
        ),
        migrations.AddField(
            model_name='itemdespachoconsumo',
            name='id_bien_solicitado',
            field=models.ForeignKey(blank=True, db_column='T084Id_BienSolicitado', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bien_solicitado', to='almacen.catalogobienes'),
        ),
        migrations.AddField(
            model_name='itemdespachoconsumo',
            name='id_bodega',
            field=models.ForeignKey(blank=True, db_column='T084Id_Bodega', null=True, on_delete=django.db.models.deletion.SET_NULL, to='almacen.bodegas'),
        ),
        migrations.AddField(
            model_name='itemdespachoconsumo',
            name='id_despacho_consumo',
            field=models.ForeignKey(db_column='T084Id_DespachoConsumo', on_delete=django.db.models.deletion.CASCADE, to='almacen.despachoconsumo'),
        ),
        migrations.AddField(
            model_name='itemdespachoconsumo',
            name='id_entrada_almacen_bien',
            field=models.ForeignKey(blank=True, db_column='T084Id_EntradaAlmacenDelBien', null=True, on_delete=django.db.models.deletion.SET_NULL, to='almacen.entradasalmacen'),
        ),
        migrations.AddField(
            model_name='itemdespachoconsumo',
            name='id_unidad_medida_solicitada',
            field=models.ForeignKey(blank=True, db_column='T084Id_UnidadMedidaSolicitada', null=True, on_delete=django.db.models.deletion.SET_NULL, to='almacen.unidadesmedida'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='despachoconsumo',
            name='id_bodega_general',
            field=models.ForeignKey(db_column='T083Id_BodegaGral', on_delete=django.db.models.deletion.CASCADE, to='almacen.bodegas'),
        ),
        migrations.AddField(
            model_name='despachoconsumo',
            name='id_entrada_almacen_cv',
            field=models.ForeignKey(blank=True, db_column='T083Id_EntradaAlmacenCV', null=True, on_delete=django.db.models.deletion.SET_NULL, to='almacen.entradasalmacen'),
        ),
        migrations.AddField(
            model_name='despachoconsumo',
            name='id_funcionario_responsable_unidad',
            field=models.ForeignKey(blank=True, db_column='T083Id_FuncionarioResponsableUnidad', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='persona_funcionario_responsable_unidad', to='seguridad.personas'),
        ),
        migrations.AddField(
            model_name='despachoconsumo',
            name='id_persona_anula',
            field=models.ForeignKey(blank=True, db_column='T083Id_PersonaAnula', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='persona_anula_despacho', to='seguridad.personas'),
        ),
        migrations.AddField(
            model_name='despachoconsumo',
            name='id_persona_despacha',
            field=models.ForeignKey(db_column='T083Id_PersonaDespacha', on_delete=django.db.models.deletion.CASCADE, related_name='persona_despacha', to='seguridad.personas'),
        ),
        migrations.AddField(
            model_name='despachoconsumo',
            name='id_persona_solicita',
            field=models.ForeignKey(blank=True, db_column='T083Id_PersonaSolicita', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='persona_solicita', to='seguridad.personas'),
        ),
        migrations.AddField(
            model_name='despachoconsumo',
            name='id_solicitud_consumo',
            field=models.ForeignKey(blank=True, db_column='T083Id_SolicitudConsumo', null=True, on_delete=django.db.models.deletion.SET_NULL, to='almacen.solicitudesconsumibles'),
        ),
        migrations.AddField(
            model_name='despachoconsumo',
            name='id_unidad_para_la_que_solicita',
            field=models.ForeignKey(blank=True, db_column='T083Id_UnidadParaLaQueSolicita', null=True, on_delete=django.db.models.deletion.SET_NULL, to='almacen.unidadesorganizacionales'),
        ),
        migrations.AddField(
