...
class InventarioViveros(models.Model):
    ...
    cod_tipo_entrada_lote = models.ForeignKey(TiposEntradas, on_delete=models.SET_NULL, null=True, blank=True, db_column='T156cod_TipoEntradaLote')
    nro_entrada_alm_lote = models.PositiveIntegerField(null=True, blank=True, db_column='T156nroEntradaAlmLote')
    fecha_ingreso_al_lote = models.DateTimeField(null=True, blank=True, db_column='T156fechaIngresoAlLote')
    ...
    cantidad_bodegas = models.PositiveIntegerField(null=True, blank=True, db_column='T156cantidadBodegas')
    consumos_internos = models.PositiveSmallIntegerField(null=True, blank=True, db_column='T156consumosInternos')
    traslados_lote_produccion_distribucion = models.PositiveIntegerField(null=True, blank=True, db_column='T156trasladosLoteProduccionADistribucion')
    salidas = models.PositiveIntegerField(null=True, blank=True, db_column='T156salidas')
