...
class SolicitudesViveros(models.Model):
    ...
    con_municipio_destino = models.CharField(max_length=5,choices=municipios_CHOICES,db_column='T173Cod_MunicipioDestino')
    ...
    id_despacho_viveros = models.IntegerField(blank=True,null=True,db_column='T173Id_DespachoDeViveros')
