...
class DespachoViveros(models.Model):
    ...
    nro_despachos_viveros = models.PositiveIntegerField(unique=True, db_column='T175nroDespachoDeViveros')
    ...
    nro_solicitud_a_viveros = models.PositiveIntegerField(db_column='T175nroSolicitudAViveros')
    ...
    ruta_archivo_con_recibido = models.FileField(db_column='T175rutaArchivoConRecibido')
...
class ItemsDespachoViveros(models.Model):
    ...
    nro_lote = models.PositiveIntegerField(blank=True, null=True, db_column='T176nroLote')
    cod_etapa_lote = models.CharField(max_length=1, blank=True, null=True, db_column='T176codEtapaLote')
    cantidad_solicitada = models.PositiveIntegerField(db_column='T176cantidadSolicitada')
    cantidad_despachada = models.PositiveIntegerField(db_column='T176cantidadDespachada')
    observacion_del_despacho = models.CharField(max_length=255,blank=True,null=True,db_column='T176observacionDelDespacho')
