...
class ItemsLevantaCuarentena(models.Model):
    ...
    id_persona_levanta = models.ForeignKey(Personas, on_delete=models.CASCADE, db_column='T165Id_PersonaLevanta', related_name='id_persona_levanta_item_cuarentena')
...
class BajasVivero(models.Model):
    ...
    id_persona_baja = models.ForeignKey(Personas, on_delete=models.CASCADE, db_column='T166Id_PersonaBaja', related_name='id_persona_baja_vivero')
...
class ItemsBajasVivero (models.Model):
    ...
    cod_etapa_lote = models.CharField(max_length=1, blank=True, null=True, choices=cod_etapa_lote_CHOICES, db_column='T167codEtapaLote')
