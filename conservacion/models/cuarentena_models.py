...
class CuarentenaMatVegetal(models.Model):
    ...
    id_bien = models.ForeignKey(CatalogoBienes, on_delete=models.CASCADE,db_column='T164Id_Vivero')
    ...
    id_persona_cuarentena = models.ForeignKey(Personas,db_column='T164Id_PersonaCuarentena')
    ...
    id_persona_anula = models.ForeignKey(Personas,related_name='persona-anula',blank=True,null=True,db_column='T164Id_PersonaAnula')
...
class ItemsLevantaCuarentena(models.Model):
    ...
    id_persona_anula = models.ForeignKey(Personas,on_delete=models.SET_NULL,blank=True,null=True,db_column='T165Id_PersonaAnula',related_name='id_persona_anula')
...
class BajasVivero(models.Model):
    ...
    id_persona_anula = models.ForeignKey(Personas,on_delete=models.SET_NULL,blank=True,null=True,related_name='persona_anula',db_column='T166Id_PersonaAnula')
