...
class Estaciones(models.Model):
    ...
    cod_tipo_estacion = models.CharField(max_length=2, choices=cod_tipo_estacion_choices, db_column='T900codTipoEstacion')
    latitud = models.FloatField(db_column='T900latitud')
    longitud = models.FloatField(db_column='T900longitud')
    cod_municipio = models.CharField(max_length=5, db_column='T900Cod_Municipio')
    indicaciones_ubicacion = models.CharField(max_length=255, db_column='T900indicacionesUbicacion')
    fecha_modificacion_coordenadas = models.DateTimeField(null=True, blank=True, db_column='T900fechaModificacionCoord')
    id_persona_modifica = models.IntegerField(db_column='T900Id_PersonaModifica')
...
class Datos(models.Model):
    ...
    temperatura_ambiente = models.FloatField(db_column='T901temperaturaAmbiente')
    humedad_ambiente = models.FloatField(db_column='T901humedadAmbiente')
    presion_barometrica = models.FloatField(db_column='T901presionBarometrica')
    velocidad_viento = models.FloatField(db_column='T901velocidadViento')
    direccion_viento = models.FloatField(db_column='T901direccionViento')
    precipitacion = models.FloatField(db_column='T901precipitacion')
    luminosidad = models.FloatField(db_column='T901luminosidad')
    nivel_agua = models.FloatField(db_column='T901nivelAgua')
    velocidad_agua = models.FloatField(db_column='T901velocidadAgua')
...
class ParametrosReferencia(models.Model):
    ...
    temperatura_ambiente_max = models.FloatField(db_column='T902temperaturaAmbienteMax')
    temperatura_ambiente_min = models.FloatField(db_column='T902temperaturaAmbienteMin')
    humedad_ambiente_max = models.FloatField(db_column='T902humedadAmbienteMax')
    humedad_ambiente_min = models.FloatField(db_column='T902humedadAmbienteMin')
    presion_barometrica_max = models.FloatField(db_column='T902presionBarometricaMax')
    presion_barometrica_min = models.FloatField(db_column='T902presionBarometricaMin')
    velocidad_viento_max = models.FloatField(db_column='T902velocidadVientoMax')
    velocidad_viento_min = models.FloatField(db_column='T902velocidadVientoMin')
    direccion_viento_max = models.FloatField(db_column='T902direccionVientoMax')
    direccion_viento_min = models.FloatField(db_column='T902direccionVientoMin')
    precipitacion_max = models.FloatField(db_column='T902precipitacionMax')
    precipitacion_min = models.FloatField(db_column='T902precipitacionMin')
    luminosidad_max = models.FloatField(db_column='T902luminosidadMax')
    luminosidad_min = models.FloatField(db_column='T902luminosidadMin')
    nivel_agua_max = models.FloatField(db_column='T902nivelAguaMax')
    nivel_agua_min = models.FloatField(db_column='T902nivelAguaMin')
    velocidad_agua_max = models.FloatField(db_column='T902velocidadAguaMax')
    velocidad_agua_min = models.FloatField(db_column='T902velocidadAguaMin')
    id_persona_modifica = models.FloatField(db_column='T902Id_PersonaModifica')
...
class AlertasEquipoEstacion(models.Model):
    ...
    nombre_variable = models.CharField(max_length=30, db_column='T903nombreVariable')
