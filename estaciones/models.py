...
class Datos(models.Model):
    ...
    temperatura_ambiente = models.DecimalField(max_digits=3, decimal_places=1, db_column='T901temperaturaAmbiente')
    humedad_ambiente = models.DecimalField(max_digits=5, decimal_places=2, db_column='T901humedadAmbiente')
    presion_barometrica = models.DecimalField(max_digits=6, decimal_places=1, db_column='T901presionBarometrica')
    velocidad_viento = models.DecimalField(max_digits=4, decimal_places=2, db_column='T901velocidadViento')
    direccion_viento = models.DecimalField(max_digits=6, decimal_places=1, db_column='T901direccionViento')
    precipitacion = models.DecimalField(max_digits=4, decimal_places=1, db_column='T901precipitacion')
    luminosidad = models.DecimalField(max_digits=5, decimal_places=2, db_column='T901luminosidad')
    nivel_agua = models.DecimalField(max_digits=5, decimal_places=2, db_column='T901nivelAgua')
    velocidad_agua = models.DecimalField(max_digits=4, decimal_places=2, db_column='T901velocidadAgua')
...
class ParametrosReferencia(models.Model):
    ...
    temperatura_ambiente_max = models.DecimalField(max_digits=3, decimal_places=1, db_column='T902temperaturaAmbienteMax')
    temperatura_ambiente_min = models.DecimalField(max_digits=3, decimal_places=1, db_column='T902temperaturaAmbienteMin')
    humedad_ambiente_max = models.DecimalField(max_digits=5, decimal_places=2, db_column='T902humedadAmbienteMax')
    humedad_ambiente_min = models.DecimalField(max_digits=5, decimal_places=2, db_column='T902humedadAmbienteMin')
    presion_barometrica_max = models.DecimalField(max_digits=6, decimal_places=1, db_column='T902presionBarometricaMax')
    presion_barometrica_min = models.DecimalField(max_digits=6, decimal_places=1, db_column='T902presionBarometricaMin')
    velocidad_viento_max = models.DecimalField(max_digits=4, decimal_places=2, db_column='T902velocidadVientoMax')
    velocidad_viento_min = models.DecimalField(max_digits=4, decimal_places=2, db_column='T902velocidadVientoMin')
    direccion_viento_max = models.DecimalField(max_digits=6, decimal_places=1, db_column='T902direccionVientoMax')
    direccion_viento_min = models.DecimalField(max_digits=6, decimal_places=1, db_column='T902direccionVientoMin')
    precipitacion_max = models.DecimalField(max_digits=4, decimal_places=1, db_column='T902precipitacionMax')
    precipitacion_min = models.DecimalField(max_digits=4, decimal_places=1, db_column='T902precipitacionMin')
    luminosidad_max = models.DecimalField(max_digits=5, decimal_places=2, db_column='T902luminosidadMax')
    luminosidad_min = models.DecimalField(max_digits=5, decimal_places=2, db_column='T902luminosidadMin')
    nivel_agua_max = models.DecimalField(max_digits=5, decimal_places=2, db_column='T902nivelAguaMax')
    nivel_agua_min = models.DecimalField(max_digits=5, decimal_places=2, db_column='T902nivelAguaMin')
    velocidad_agua_max = models.DecimalField(max_digits=4, decimal_places=2, db_column='T902velocidadAguaMax')
    velocidad_agua_min = models.DecimalField(max_digits=4, decimal_places=2, db_column='T902velocidadAguaMin')
